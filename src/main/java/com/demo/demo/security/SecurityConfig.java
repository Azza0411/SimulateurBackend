  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http.cors(withDefaults())
            ...
            .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers("/api/simulations/**").permitAll()  // ← AJOUT : Full public pour tester flow (revert après en hasAnyAuthority)
                    //.requestMatchers(HttpMethod.GET, "/api/simulations/status/**").hasAnyAuthority("TRADER", "ADMIN")  // ← Restreint (comme Postman avec token)
